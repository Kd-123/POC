...
export const routingComponents = [LoginPageComponent,RegistrationPageComponent,HomePageComponent,ProfileComponent,PageNotFoundComponent,DashboardComponent,CharactersComponent,ChangePasswordComponent];
